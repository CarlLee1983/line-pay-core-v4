...
We actively support the following versions of `line-pay-core-v4`:
...
We take the security of `line-pay-core-v4` seriously. If you discover a security vulnerability, please follow these steps:
...
- **Email**: [Your Security Email - Please update this]
- **Subject**: `[SECURITY] line-pay-core-v4: [Brief Description]`
...
When using `line-pay-core-v4`, please follow these security best practices:

#### Channel Secret Protection
```typescript
// ❌ DON'T: Hard-code secrets
const client = new LinePayBaseClient({
...
Regularly update `line-pay-core-v4` and its dependencies to receive security patches:

```bash
bun update line-pay-core-v4
```

## Security Features

`line-pay-core-v4` includes the following security features:
...
### 4. Zero Dependencies
No runtime dependencies reduces the attack surface and dependency-related vulnerabilities.
